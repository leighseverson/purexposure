...
The `outlier` column is a logical value indicating whether the record has been flagged as an outlier, in which case `kg_chm_used` has been replaced with a calculated maximum rate of application. The algorithm used to identify and correct erroneously high records of application was developed based on methods used by @Gunier2001. 
