...
For documentation of raw PUR data, you can reference the Pesticide Use Report Data User Guide & Documentation document published by the CA Department of Pesticide Regulation. The file is saved as "cd_doc.pdf" in any  "pur[year].zip" file between 1990 and 2016 found here: ftp://transfer.cdpr.ca.gov/pub/outgoing/pur_archives/. 
...
knitr::include_graphics("figures/monroe_county_plot.png")
```
...
```
```{r echo = FALSE, fig.align = "center"}
knitr::include_graphics("figures/locations_plot.png")
```
...
```{r echo = FALSE, fig.align = "center"}
knitr::include_graphics("figures/ex_directory.png")
```
...
```{r echo = FALSE, fig.align = "center", out.width = "400pt", out.height = "400pt"}
