...
For example, too see how active ingredients matching "methyl bromide" or "abietic" were recorded in the year 2000, we can use the `find_chemical_codes` function, which pulls the PUR Chemical Lookup table for a particular year: 
