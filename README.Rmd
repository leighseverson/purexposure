...
```
```{r echo = FALSE}
load("vignettes/data/unique_classes.RData")
...
```
```{r echo = FALSE}
load("vignettes/data/se_exposure.RData")
```
```{r eval = FALSE}
...
```
```{r echo = FALSE}
load("vignettes/data/se_cv.RData")
```
```{r echo = FALSE}
se_cv
```
...
```
```{r echo = FALSE}
load("vignettes/data/fresno_data.RData")
```
```{r echo = FALSE}
fresno_data
```
